...
class PODOFO_DOC_API PdfInfo : public PdfElement {
 public:
	...
	inline const PdfString & GetCreationDate() const;
	inline const PdfString & GetModifyDate() const;
...
const PdfString & PdfInfo::GetCreationDate() const
{
	return  this->GetStringFromInfoDict( PdfName("CreationDate") );
}

const PdfString & PdfInfo::GetModifyDate() const
{
	return this->GetStringFromInfoDict( PdfName("ModDate") );
}
};
